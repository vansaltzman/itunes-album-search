...
it('renders without crashing', () => {
  ...
  ReactDOM.render(<AlbumContainer />, div);
...
test('when parsing, link should be the same as collectionViewUrl', () => {  
  expect(results[0].link).toBe(exampleData[0].collectionViewUrl)
});